...
function createSeoRouter({ productsFile, publicDir, siteUrl, readJSON, writeJSON, escH }) {
  ...
  function socialIcon(name) {
    const icons = {"max":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><defs><linearGradient id=\"max-gradient\" x1=\"3\" y1=\"21\" x2=\"21\" y2=\"3\" gradientUnits=\"userSpaceOnUse\"><stop stop-color=\"#26c9e8\"/><stop offset=\".45\" stop-color=\"#5637d7\"/><stop offset=\"1\" stop-color=\"#8a34e8\"/></linearGradient></defs><rect x=\"2\" y=\"2\" width=\"20\" height=\"20\" rx=\"5\" fill=\"url(#max-gradient)\"/><path fill=\"#fff\" d=\"M7 7h5.4a4.8 4.8 0 1 1 0 9.6H10v-2.8h2.2a2 2 0 1 0 0-4H10v7.2H7V7Z\"/><path fill=\"#fff\" d=\"M7 15.8h3.1L7 19v-3.2Z\"/></svg>","tg":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"m20.5 4.2-3 15.1c-.2 1.1-1 1.4-1.9.9l-4.9-3.6-2.4 2.3c-.3.3-.5.5-1 .5l.4-5 9.1-8.2c.4-.4-.1-.6-.6-.3L5.1 12.8.4 11.3c-1-.3-1-1 .2-1.5L19 2.7c.9-.3 1.7.2 1.5 1.5Z\"/></svg>","vk":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M4 7.2h2.9c.2 4.1 2.1 6.6 3.6 7.1V7.2h2.7v4.1c1.5-.2 3-2.5 3.6-4.1h2.7c-.5 2-2.2 4.4-3.4 5.4 1.2.8 3.1 2.9 3.8 5.2h-3c-.7-1.6-2-3.5-3.7-3.7v3.7h-.3C7.8 17.8 4.7 14.3 4 7.2Z\"/></svg>"};
    return icons[name] || '';
  }
